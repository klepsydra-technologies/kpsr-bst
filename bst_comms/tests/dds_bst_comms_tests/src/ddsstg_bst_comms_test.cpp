...
TEST(DDSStgCoreTests, PubSubTest)
{
    ...
    SimpleWriteService writeService(nullptr,
                                    provider.getToMiddlewareChannel<bst::comms::SystemInitialize_t,
                                                                    kpsr_dds_bst::BstPacketData>(
                                        "bst_system_init", 0, nullptr, &dw));
    ...
    _fromDDSMiddlewareProvider.registerToTopic("bst_system_init",
                                               &dr,
                                               true,
                                               eventEmitter.getPublisher());
