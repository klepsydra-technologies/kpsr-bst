...
public:
    ...
    {
        {
            kpsr::Publisher<kpsr::bst::BstRequestMessage> *publisher =
                _eventloopProvider
                    .template getPublisher<kpsr::bst::BstRequestMessage>(EVENT_NAME_BST_REQUEST,
                                                                         0,
                                                                         nullptr,
                                                                         nullptr);
            _fromDDSMiddlewareProvider.registerToTopic(EVENT_NAME_BST_REQUEST,
                                                       _bstRequestDataReader,
                                                       true,
                                                       publisher);
        }

        {
            kpsr::Publisher<kpsr::bst::WaypointCommandMessage> *publisher =
                _eventloopProvider
                    .template getPublisher<kpsr::bst::WaypointCommandMessage>(EVENT_NAME_BST_WP_CMD,
                                                                              0,
                                                                              nullptr,
                                                                              nullptr);
            _fromDDSMiddlewareProvider.registerToTopic(EVENT_NAME_BST_WP_CMD,
                                                       _bstWaypointCommandDataReader,
                                                       true,
                                                       publisher);
        }
    ...
    void stop() override
    {
        _fromDDSMiddlewareProvider.unregisterFromTopic(EVENT_NAME_BST_REQUEST,
                                                       _bstRequestDataReader);

        _fromDDSMiddlewareProvider.unregisterFromTopic(EVENT_NAME_BST_WP_CMD,
                                                       _bstWaypointCommandDataReader);
    ...
    {
        return _eventloopProvider.template getSubscriber<kpsr::bst::BstRequestMessage>(
    ...
    kpsr::Publisher<kpsr::bst::BstReplyMessage> *getBst2KpsrReplyMessagePublisher()
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<kpsr::bst::BstReplyMessage, kpsr_dds_bst::BstReplyData>(
                EVENT_NAME_BST_REPLY, 0, nullptr, _bstReplyDataWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<kpsr::geometry::PoseEventData, kpsr_dds_geometry::PoseEventData>(
                EVENT_NAME_POSE_EVENT, 0, nullptr, _poseDataWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<SystemInitialize_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_SYSTEM_INIT, 0, nullptr, _systemInitializeWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<TelemetryPosition_t, kpsr_dds_bst::BstPacketData>(
                "dds_bst_telemetry_position", 0, nullptr, _telemetryPositionWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<TelemetryOrientation_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_TELEMETRY_ORI, 0, nullptr, _telemetryPositionWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<Sensors_t, kpsr_dds_bst::BstPacketData>(EVENT_NAME_SENSOR,
                                                                            0,
                                                                            nullptr,
                                                                            _sensorsWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<CalibrateSensor_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_CALIBRATE, 0, nullptr, _calibrateSensorWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<Command_t, kpsr_dds_bst::BstPacketData>(EVENT_NAME_CONTROL_CMD,
                                                                            0,
                                                                            nullptr,
                                                                            _commandWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<PID_t, kpsr_dds_bst::BstPacketData>(EVENT_NAME_CONTROL_PID,
                                                                        0,
                                                                        nullptr,
                                                                        _pidWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<uint8_t, kpsr_dds_serialization::OctetData>(EVENT_NAME_SYSTEM,
                                                                                0,
                                                                                nullptr,
                                                                                _systemWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<TelemetrySystem_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_TELEMETRY_SYS, 0, nullptr, _telemetrySystemWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<TelemetryPressure_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_TELEMETRY_PRES, 0, nullptr, _telemetryPressureWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<::bst::comms::TelemetryControl_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_TELEMETRY_CTRL, 0, nullptr, _telemetryControlWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<gcs::TelemetryGCS_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_TELEMETRY_GCS, 0, nullptr, _telemetryGCSWriter);
    }
    ...
    {
        return _toDDSMiddlewareProvider
            .getToMiddlewareChannel<PayloadControl_t, kpsr_dds_bst::BstPacketData>(
                EVENT_NAME_PAYLOAD_CONTROL, 0, nullptr, _payloadControlWriter);
    }
