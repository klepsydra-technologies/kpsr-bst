...
kpsr::bst::mem::BstClientServerMemProvider::BstClientServerMemProvider(Container *container)
    : _bstRequestMessageMiddlewareProvider(container,
                                           EVENT_NAME_BST_REQUEST,
                                           8,
                                           0,
                                           nullptr,
                                           nullptr,
                                           false)
    , _bstWaypointCommandMessageMiddlewareProvider(container,
                                                   EVENT_NAME_BST_WP_CMD,
                                                   8,
                                                   0,
                                                   nullptr,
                                                   nullptr,
                                                   false)
    , _bstReplyMessageMiddlewareProvider(container,
    ...
    , _systemInitializeMiddlewareProvider(container,
                                          EVENT_NAME_SYSTEM_INIT,
                                          8,
                                          0,
                                          nullptr,
                                          nullptr,
                                          false)
    , _telemetryPositionMiddlewareProvider(container,
                                           ...
                                           nullptr,
                                           true)
    , _telemetryOrientationMiddlewareProvider(container,
    ...
    , _controlCommandMiddlewareProvider(container,
                                        EVENT_NAME_CONTROL_CMD,
                                        8,
                                        0,
                                        nullptr,
                                        nullptr,
    ...
    , _telemetrySystemMiddlewareProvider(container,
                                         ...
                                         nullptr,
                                         false)
    , _telemetryPressureMiddlewareProvider(container,
                                           ...
                                           nullptr,
                                           true)
    , _telemetryControlMiddlewareProvider(container,
                                          ...
                                          nullptr,
                                          true)
    , _telemetryGCSMiddlewareProvider(container,
                                      ...
                                      nullptr,
                                      true)
    , _payloadControlMiddlewareProvider(container,
...
kpsr::Subscriber<kpsr::bst::BstRequestMessage>
    *kpsr::bst::mem::BstClientServerMemProvider::getBstRequestMessageSubscriber()
{
    return _bstRequestMessageMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<kpsr::bst::BstRequestMessage>
    *kpsr::bst::mem::BstClientServerMemProvider::getBstRequestMessagePublisher()
{
    return _bstRequestMessageMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<kpsr::bst::WaypointCommandMessage>
    *kpsr::bst::mem::BstClientServerMemProvider::getBstWaypointCommandMessageSubscriber()
{
    return _bstWaypointCommandMessageMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<kpsr::bst::WaypointCommandMessage>
    *kpsr::bst::mem::BstClientServerMemProvider::getBstWaypointCommandMessagePublisher()
{
    return _bstWaypointCommandMessageMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<kpsr::bst::BstReplyMessage>
    *kpsr::bst::mem::BstClientServerMemProvider::getBst2KpsrReplyMessageSubscriber()
{
    return _bstReplyMessageMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<kpsr::bst::BstReplyMessage>
    *kpsr::bst::mem::BstClientServerMemProvider::getBst2KpsrReplyMessagePublisher()
{
    return _bstReplyMessageMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<kpsr::geometry::PoseEventData>
    *kpsr::bst::mem::BstClientServerMemProvider::getPoseEventDataSubscriber()
{
    return _poseEventDataMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<kpsr::geometry::PoseEventData>
    *kpsr::bst::mem::BstClientServerMemProvider::getPoseEventDataPublisher()
{
    return _poseEventDataMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<SystemInitialize_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getSystemInitializeSubscriber()
{
    return _systemInitializeMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<SystemInitialize_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getSystemInitializePublisher()
{
    return _systemInitializeMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<TelemetryPosition_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryPositionSubscriber()
{
    return _telemetryPositionMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<TelemetryPosition_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryPositionPublisher()
{
    return _telemetryPositionMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<TelemetryOrientation_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryOrientationSubscriber()
{
    return _telemetryOrientationMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<TelemetryOrientation_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryOrientationPublisher()
{
...
kpsr::Subscriber<CalibrateSensor_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getCalibrateSubscriber()
{
    return _calibrateMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<CalibrateSensor_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getCalibratePublisher()
{
...
kpsr::Subscriber<TelemetrySystem_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetrySystemSubscriber()
{
    return _telemetrySystemMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<TelemetrySystem_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetrySystemPublisher()
{
    return _telemetrySystemMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<TelemetryPressure_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryPressureSubscriber()
{
    return _telemetryPressureMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<TelemetryPressure_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryPressurePublisher()
{
    return _telemetryPressureMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<::bst::comms::TelemetryControl_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryControlSubscriber()
{
    return _telemetryControlMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<::bst::comms::TelemetryControl_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryControlPublisher()
{
    return _telemetryControlMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<gcs::TelemetryGCS_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryGCSSubscriber()
{
    return _telemetryGCSMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<gcs::TelemetryGCS_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getTelemetryGCSPublisher()
{
    return _telemetryGCSMiddlewareProvider.getPublisher();
}

kpsr::Subscriber<PayloadControl_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getPayloadControlSubscriber()
{
    return _payloadControlMiddlewareProvider.getSubscriber();
}
kpsr::Publisher<PayloadControl_t>
    *kpsr::bst::mem::BstClientServerMemProvider::getPayloadControlPublisher()
{
