...
@endcode
 */
class BstClientServerEventLoopProvider : public BstClientMiddlewareProvider,
                                         public BstServerMiddlewareProvider
{
public:
    /**
     ...
     */
    BstClientServerEventLoopProvider(
     ...
     * @return
     */
    kpsr::Publisher<kpsr::bst::WaypointCommandMessage> *getBstWaypointCommandMessagePublisher()
        override
    {
        return _eventloopProvider
    ...
    {
        return _eventloopProvider.template getPublisher<SystemInitialize_t>(EVENT_NAME_SYSTEM_INIT,
                                                                            0,
                                                                            nullptr,
                                                                            nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<TelemetryPosition_t>(EVENT_NAME_TELEMETRY_POS,
                                                                             0,
                                                                             nullptr,
                                                                             nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<Sensors_t>(EVENT_NAME_SENSOR,
                                                                   0,
                                                                   nullptr,
                                                                   nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<CalibrateSensor_t>(EVENT_NAME_CALIBRATE,
                                                                           0,
                                                                           nullptr,
                                                                           nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<Command_t>(EVENT_NAME_CONTROL_CMD,
                                                                   0,
                                                                   nullptr,
                                                                   nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<PID_t>(EVENT_NAME_CONTROL_PID,
                                                               0,
                                                               nullptr,
                                                               nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<uint8_t>(EVENT_NAME_SYSTEM,
                                                                 0,
                                                                 nullptr,
                                                                 nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<TelemetrySystem_t>(EVENT_NAME_TELEMETRY_SYS,
                                                                           0,
                                                                           nullptr,
                                                                           nullptr);
    }
    ...
    {
        return _eventloopProvider
            .template getPublisher<::bst::comms::TelemetryControl_t>(EVENT_NAME_TELEMETRY_CTRL,
                                                                     0,
                                                                     nullptr,
                                                                     nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<gcs::TelemetryGCS_t>(EVENT_NAME_TELEMETRY_GCS,
                                                                             0,
                                                                             nullptr,
                                                                             nullptr);
    }
    ...
    {
        return _eventloopProvider.template getPublisher<PayloadControl_t>(EVENT_NAME_PAYLOAD_CONTROL,
                                                                          0,
                                                                          nullptr,
                                                                          nullptr);
    }
     ...
     * @return
     */
    Scheduler *getScheduler() { return _eventloopProvider.getScheduler(); }
