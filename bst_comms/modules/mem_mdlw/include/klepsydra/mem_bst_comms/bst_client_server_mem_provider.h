...
@endcode
 */
class BstClientServerMemProvider : public BstClientMiddlewareProvider,
...
private:
    ...
    kpsr::mem::BasicMiddlewareProvider<WaypointCommandMessage>
        _bstWaypointCommandMessageMiddlewareProvider;
    ...
    kpsr::mem::BasicMiddlewareProvider<TelemetryOrientation_t>
        _telemetryOrientationMiddlewareProvider;
    ...
    kpsr::mem::BasicMiddlewareProvider<::bst::comms::TelemetryControl_t>
        _telemetryControlMiddlewareProvider;
